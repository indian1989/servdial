 ...
 * Props:
 *   - categories: array of category objects from backend (should have _id, name, icon)
 *   - city: detected city for search URL
 */
const CategoriesGrid = ({ categories, city }) => {
  ...
  // Prevent rendering if no categories
