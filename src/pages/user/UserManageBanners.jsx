// frontend/src/pages/user/UserManageBanners.jsx
 ...
 * ==================================================
 *
 * User-side banner management.
 *
 * Responsibilities:
 * - Fetch user's banners
 * - Search banners
 * - Show banner status
 * - Show placement
 * - Show city/category targeting
 * - Open banner link
 * - Delete own banner
 * - Create new banner
 *
 * API:
 * GET    /user/banners
 * DELETE /user/banners/:id
 *
 * No provider business-management logic.
 * ==================================================
 */

const UserManageBanners = () => {
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-6">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">
            View and manage your promotional campaigns
          </p>
...
export default UserManageBanners;