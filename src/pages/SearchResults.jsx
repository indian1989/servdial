...
const SearchResultsMap = lazy(
  () => import("../components/search/SearchResultsMap")
);
...
/>
  ...
  <Suspense
  fallback={
    <div className="h-[75vh] mt-4 rounded-xl bg-gray-100 flex items-center justify-center text-sm text-gray-500">
      Loading map...
    </div>
  }
>
  <SearchResultsMap
    ...
    mapCenter={mapCenter}
    filters={filters}
    onBusinessSelect={async (business) => {
      await trackBusinessView(business);
